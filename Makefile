...
ARCHIVES = https://repo1.maven.org/maven2/com/github/spotbugs/spotbugs-annotations/3.1.9/spotbugs-annotations-3.1.9.jar : https://repo1.maven.org/maven2/com/github/spotbugs/spotbugs-annotations/3.1.9/spotbugs-annotations-3.1.9.pom : https://repo.gradle.org/gradle/libs-releases/com/github/spotbugs/spotbugs-gradle-plugin/1.6.9/spotbugs-gradle-plugin-1.6.9.jar : https://repo.gradle.org/gradle/libs-releases/com/github/spotbugs/spotbugs-gradle-plugin/1.6.9/spotbugs-gradle-plugin-1.6.9.pom : 
